...
## Project Structure
    ...
    ├── testapiautosetting_124483  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124483`
...
2. Clone this repo and `cd testapiautosetting_124483`
